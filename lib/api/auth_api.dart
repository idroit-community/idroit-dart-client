...
class AuthApi {
  ...
  Future<GetProfileResponseDto> authControllerGetProfile() async {
    ...
    String path = "/api/v1/auth/profile".replaceAll("{format}","json");
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'GetProfileResponseDto') as GetProfileResponseDto ;
    } else {
      return null;
    }
  }
  ...
  Future<SignInResponseDto> authControllerLogin(SignInDto body) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'SignInResponseDto') as SignInResponseDto ;
    } else {
      return null;
    }
  }
