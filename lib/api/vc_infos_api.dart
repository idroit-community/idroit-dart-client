...
class VcInfosApi {
  ...
  VcInfosApi([ApiClient apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<VcInfoResponseDto> vcInfosControllerAddLabel(AddLabelToVcInfoDto body, String id) async {
    ...
    String path = "/api/v1/vc-infos/{id}/label".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'VcInfoResponseDto') as VcInfoResponseDto ;
    } else {
      return null;
    }
  }
  ...
  Future vcInfosControllerConnectUser(UpdateVcInfoDto body, String id) async {
    ...
    // create path and map variables
    String path = "/api/v1/vc-infos/{id}".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
  ...
  Future<VcInfoResponseDto> vcInfosControllerCreate(CreateVcInfoDto body) async {
    ...
    // create path and map variables
    String path = "/api/v1/vc-infos".replaceAll("{format}","json");
  ...
  Future vcInfosControllerDisconnectUser(String id) async {
    ...
    // create path and map variables
    String path = "/api/v1/vc-infos/{id}/user".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
  ...
  Future<VcInfosResponseDto> vcInfosControllerFindAll({ double page, double limit, String label, String description }) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'VcInfosResponseDto') as VcInfosResponseDto ;
    } else {
      return null;
    }
  }
  ...
  Future<VcInfoResponseDto> vcInfosControllerIssue(IssueVcInfoDto body) async {
    ...
    // create path and map variables
    String path = "/api/v1/vc-infos/issue".replaceAll("{format}","json");
  ...
  Future<VcInfoResponseDto> vcInfosControllerUpload(Object credentialObject, String label, String description) async {
    ...
    // create path and map variables
    String path = "/api/v1/vc-infos/upload".replaceAll("{format}","json");
