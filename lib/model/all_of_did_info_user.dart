...
/* ユーザーアカウントの更新日時 */
  ...
  static List<AllOfDidInfoUser> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfDidInfoUser>() : json.map((value) => new AllOfDidInfoUser.fromJson(value)).toList();
  }

  static Map<String, AllOfDidInfoUser> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfDidInfoUser>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfDidInfoUser.fromJson(value));
    }
    return map;
  }
}
