...
class AllOfFileResponseDtoCreatedBy {
  /* アカウントの識別子 */
  String id = null;
/* アカウントの名前 */
  String name = null;
...
/* ユーザーアカウントの更新日時 */
  ...
  static List<AllOfFileResponseDtoCreatedBy> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfFileResponseDtoCreatedBy>() : json.map((value) => new AllOfFileResponseDtoCreatedBy.fromJson(value)).toList();
  }

  static Map<String, AllOfFileResponseDtoCreatedBy> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfFileResponseDtoCreatedBy>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfFileResponseDtoCreatedBy.fromJson(value));
    }
    return map;
  }
}
