...
class AllOfVcSchemaResponseDtoCreatedBy {
  /* アカウントの識別子 */
  String id = null;
/* アカウントの名前 */
  String name = null;
...
/* ユーザーアカウントの更新日時 */
  ...
  static List<AllOfVcSchemaResponseDtoCreatedBy> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfVcSchemaResponseDtoCreatedBy>() : json.map((value) => new AllOfVcSchemaResponseDtoCreatedBy.fromJson(value)).toList();
  }

  static Map<String, AllOfVcSchemaResponseDtoCreatedBy> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfVcSchemaResponseDtoCreatedBy>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfVcSchemaResponseDtoCreatedBy.fromJson(value));
    }
    return map;
  }
}
