...
/* ユーザーアカウントの更新日時 */
  ...
  static List<AllOfGroupCreatedBy> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfGroupCreatedBy>() : json.map((value) => new AllOfGroupCreatedBy.fromJson(value)).toList();
  }

  static Map<String, AllOfGroupCreatedBy> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfGroupCreatedBy>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfGroupCreatedBy.fromJson(value));
    }
    return map;
  }
}
