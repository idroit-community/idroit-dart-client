...
/* (任意) このアカウントを作成したユーザー */
  AllOfUserCreatedBy createdBy = null;
...
/* ユーザーアカウントの更新日時 */
  ...
  User.fromJson(Map<String, dynamic> json) {
    ...
    status = json['status'];
    role = json['role'];
    createdBy = new AllOfUserCreatedBy.fromJson(json['createdBy']);
