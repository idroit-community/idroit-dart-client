...
/* ユーザーアカウントの更新日時 */
  ...
  static List<AllOfVcSchemaCreatedBy> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfVcSchemaCreatedBy>() : json.map((value) => new AllOfVcSchemaCreatedBy.fromJson(value)).toList();
  }

  static Map<String, AllOfVcSchemaCreatedBy> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfVcSchemaCreatedBy>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfVcSchemaCreatedBy.fromJson(value));
    }
    return map;
  }
}
