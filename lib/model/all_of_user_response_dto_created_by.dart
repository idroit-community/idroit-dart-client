...
class AllOfUserResponseDtoCreatedBy {
  /* アカウントの識別子 */
  String id = null;
/* アカウントの名前 */
  String name = null;
...
/* ユーザーアカウントの更新日時 */
  ...
  static List<AllOfUserResponseDtoCreatedBy> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfUserResponseDtoCreatedBy>() : json.map((value) => new AllOfUserResponseDtoCreatedBy.fromJson(value)).toList();
  }

  static Map<String, AllOfUserResponseDtoCreatedBy> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfUserResponseDtoCreatedBy>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfUserResponseDtoCreatedBy.fromJson(value));
    }
    return map;
  }
}
