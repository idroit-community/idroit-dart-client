...
/* ユーザーアカウントの更新日時 */
  ...
  static List<AllOfDidInfoCreatedBy> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfDidInfoCreatedBy>() : json.map((value) => new AllOfDidInfoCreatedBy.fromJson(value)).toList();
  }

  static Map<String, AllOfDidInfoCreatedBy> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfDidInfoCreatedBy>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfDidInfoCreatedBy.fromJson(value));
    }
    return map;
  }
}
