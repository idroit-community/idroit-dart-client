...
/* ユーザーアカウントの更新日時 */
  ...
  static List<AllOfVcInfoCreatedBy> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfVcInfoCreatedBy>() : json.map((value) => new AllOfVcInfoCreatedBy.fromJson(value)).toList();
  }

  static Map<String, AllOfVcInfoCreatedBy> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfVcInfoCreatedBy>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfVcInfoCreatedBy.fromJson(value));
    }
    return map;
  }
}
