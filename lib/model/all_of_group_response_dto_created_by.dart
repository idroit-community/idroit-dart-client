...
class AllOfGroupResponseDtoCreatedBy {
  /* アカウントの識別子 */
  String id = null;
/* アカウントの名前 */
  String name = null;
...
/* ユーザーアカウントの更新日時 */
  ...
  static List<AllOfGroupResponseDtoCreatedBy> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfGroupResponseDtoCreatedBy>() : json.map((value) => new AllOfGroupResponseDtoCreatedBy.fromJson(value)).toList();
  }

  static Map<String, AllOfGroupResponseDtoCreatedBy> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfGroupResponseDtoCreatedBy>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfGroupResponseDtoCreatedBy.fromJson(value));
    }
    return map;
  }
}
