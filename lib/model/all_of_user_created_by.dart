...
/* ユーザーアカウントの更新日時 */
  ...
  static List<AllOfUserCreatedBy> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfUserCreatedBy>() : json.map((value) => new AllOfUserCreatedBy.fromJson(value)).toList();
  }

  static Map<String, AllOfUserCreatedBy> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfUserCreatedBy>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfUserCreatedBy.fromJson(value));
    }
    return map;
  }
}
