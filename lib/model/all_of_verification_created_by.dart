...
class AllOfVerificationCreatedBy {
  /* アカウントの識別子 */
  String id = null;
/* アカウントの名前 */
  String name = null;
...
/* ユーザーアカウントの更新日時 */
  ...
  static List<AllOfVerificationCreatedBy> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfVerificationCreatedBy>() : json.map((value) => new AllOfVerificationCreatedBy.fromJson(value)).toList();
  }

  static Map<String, AllOfVerificationCreatedBy> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfVerificationCreatedBy>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfVerificationCreatedBy.fromJson(value));
    }
    return map;
  }
}
