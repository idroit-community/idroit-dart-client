...
/* ユーザーアカウントの更新日時 */
  ...
  static List<AllOfVpInfoUser> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfVpInfoUser>() : json.map((value) => new AllOfVpInfoUser.fromJson(value)).toList();
  }

  static Map<String, AllOfVpInfoUser> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfVpInfoUser>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfVpInfoUser.fromJson(value));
    }
    return map;
  }
}
