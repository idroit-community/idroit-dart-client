...
/* ユーザーアカウントの更新日時 */
  ...
  static List<AllOfVcInfoUser> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfVcInfoUser>() : json.map((value) => new AllOfVcInfoUser.fromJson(value)).toList();
  }

  static Map<String, AllOfVcInfoUser> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfVcInfoUser>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfVcInfoUser.fromJson(value));
    }
    return map;
  }
}
