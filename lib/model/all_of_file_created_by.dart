...
/* ユーザーアカウントの更新日時 */
  ...
  static List<AllOfFileCreatedBy> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfFileCreatedBy>() : json.map((value) => new AllOfFileCreatedBy.fromJson(value)).toList();
  }

  static Map<String, AllOfFileCreatedBy> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfFileCreatedBy>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfFileCreatedBy.fromJson(value));
    }
    return map;
  }
}
