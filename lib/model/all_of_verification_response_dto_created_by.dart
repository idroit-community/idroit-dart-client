...
class AllOfVerificationResponseDtoCreatedBy {
  /* アカウントの識別子 */
  String id = null;
/* アカウントの名前 */
  String name = null;
...
/* ユーザーアカウントの更新日時 */
  ...
  static List<AllOfVerificationResponseDtoCreatedBy> listFromJson(List<dynamic> json) {
    return json == null ? new List<AllOfVerificationResponseDtoCreatedBy>() : json.map((value) => new AllOfVerificationResponseDtoCreatedBy.fromJson(value)).toList();
  }

  static Map<String, AllOfVerificationResponseDtoCreatedBy> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, AllOfVerificationResponseDtoCreatedBy>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new AllOfVerificationResponseDtoCreatedBy.fromJson(value));
    }
    return map;
  }
}
